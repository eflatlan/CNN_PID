...
void backgroundStudy(Int_t NumberOfEvents = 1, Int_t NumberOfClusters = 13, Double_t Hwidth = 0.013, double degThetaP = 0, double degPhiP = 0)   
{
  ...
  TH2F *hphotonMapX0 = new TH2F(Form("Photon Map X0 #Theta = %f #Phi P = %f", degThetaP, degPhiP),Form("Photon Map X0 #Theta = %f #Phi P = %f ; x [Pads]; y [Pads]" , degThetaP, degPhiP),1000,-10.,10.,1000,-10.,10.);

  TH2F *hphotonMapXf = new TH2F(Form("Photon Map XF #Theta = %f", degThetaP),Form("Photon Map XF #Theta = %f ; x [Pads]; y [Pads]" , degThetaP),1000,-10.,10.,1000,-10.,10.);

  TH2F *hphotonMapCen = new TH2F(Form("Photon Map Cen #Theta = %f", degThetaP),Form("Photon Map Cen #Theta = %f ; x [Pads]; y [Pads]" , degThetaP),1000,-10.,10.,1000,-10.,10.);
