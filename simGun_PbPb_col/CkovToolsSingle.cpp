        ...
        for (auto &photons : clusterTrack)
        {
            ...
            if (photons.mX == mipX &&
                ...
                photons.mY ==
                    ...
                    mipY /*&& photons.mQ ==  mipCharge*/)
            { // current cluster is mip
...
bool
lineIntersects(const TVector2 &B, const std::array<double, 2> &C, const std::array<double, 2> &D, double rUncertainty, TVector2 &intersection, bool &pointIsInside)
{
                 ...
                 Double_t phiC, Double_t betaM)
{
    ...
    Double_t SigCrom(Double_t dtdn)
    {
    ...
    {
        const float lMax = 1.5;
        const auto trkPC2 = populatePtrInner->getPcImp();
        const auto trkRad2 = populatePtrInner->getTrackPos();
