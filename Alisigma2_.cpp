...
class Alisigma2_ 
{
 ...
 public:
...

    {
      ...
      const double sigmaTrack = 0.002; // 2mRad unc wrt tracking
      
      double sigmaRes2 = std::sqrt(sigLocVar*sigLocVar + sigGeomVar*sigGeomVar + sigCromVar*sigCromVar + sigmaTrack*sigmaTrack);
     
     


      // std::cout << "sigLocVar " << sigLocVar << " | sigGeomVar " << sigGeomVar << " | sigCromVar " << sigCromVar << " || == sigmaResSq " << sigmaRes2<<std::endl;
      
      // std::cout << "sigLocVarSq " << sigLocVar*sigLocVar << " | sigGeomVarSq " << sigGeomVar*sigGeomVar << " | sigCromVarSq " << sigCromVar*sigCromVar << std::endl;
