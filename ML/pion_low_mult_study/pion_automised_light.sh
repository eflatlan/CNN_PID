...
for i in {0..25000}; do
    ...
    /root/alice/O2/prodtests/sim_challenge_light_Custom.sh -f simp -n 1350 -j 5|| { echo "sim_challengeCustom.sh failed"; exit 1; }
    ...
    mv ParticleInfo2.h5 lowParticle211_Ckov${i}_.h5 || { echo "File rename failed"; exit 1; }
done
