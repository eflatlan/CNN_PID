...
for i in {0..100}; do
    ...
    /root/alice/O2/prodtests/sim_challengeCustom.sh -f simp -n 250 || { echo "sim_challengeCustom.sh failed"; exit 1; }
    ...
    mv ParticleInfo2.h5 Particle211_Ckov${i}_.h5 || { echo "File rename failed"; exit 1; }
done
