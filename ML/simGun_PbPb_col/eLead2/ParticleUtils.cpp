...
public:
  ...
  saveParticleInfoToHDF5(std::vector<ParticleInfo> &particleVector) {
    ...
    for (size_t i = 0; i < particleVector.size(); ++i) {
      ...
      Printf("ParticleUtils ::: size of candValus = %zu",
             particle.candsCombined.size());
      for (const auto &cand : particle.candsCombined) {
        ...
        // Printf("db x_ %.2f y %.2f cStat %d", cand.x, cand.y,
        // cand.candStatus);
      }
      ...
      attribute = particleGroup.createAttribute("Mass", PredType::NATIVE_DOUBLE,
                                                attr_dataspace);
      attribute.write(PredType::NATIVE_DOUBLE, &particle.mass);

      attribute = particleGroup.createAttribute(
          "Energy", PredType::NATIVE_DOUBLE, attr_dataspace);
      ...
      attribute = particleGroup.createAttribute("Ckov", PredType::NATIVE_DOUBLE,
                                                attr_dataspace);
      attribute.write(PredType::NATIVE_DOUBLE, &particle.ckov);

      attribute = particleGroup.createAttribute("xRad", PredType::NATIVE_DOUBLE,
                                                attr_dataspace);
      ...
      attribute = particleGroup.createAttribute("xPC", PredType::NATIVE_DOUBLE,
                                                attr_dataspace);
      attribute.write(PredType::NATIVE_DOUBLE, &particle.xPC);

      attribute = particleGroup.createAttribute("yPC", PredType::NATIVE_DOUBLE,
                                                attr_dataspace);
      ...
      for (int i = 0; i < 4; i++) {
        ...
        attribute = particleGroup.createAttribute(str, PredType::NATIVE_DOUBLE,
                                                  attr_dataspace);
        attribute.write(PredType::NATIVE_INT, &particle.arrayInfo[i]);
      }
      /*
attribute = particleGroup.createAttribute("C2x", PredType::NATIVE_DOUBLE,
attr_dataspace); attribute.write(PredType::NATIVE_DOUBLE,
&particle.candsCombined.x);

attribute = particleGroup.createAttribute("C2y", PredType::NATIVE_DOUBLE,
attr_dataspace); attribute.write(PredType::NATIVE_DOUBLE,
&particle.candsCombined.y);


attribute = particleGroup.createAttribute("candStatus", PredType::NATIVE_DOUBLE,
attr_dataspace); attribute.write(PredType::NATIVE_INT,
&particle.candsCombined.candStatus);
*/
      ...
      H5::DataSet datasetVec2 =
          particleGroup.createDataSet("candsCombined", mtype, dataspaceVec2);
      ...
      H5::DataSet datasetVecX =
          particleGroup.createDataSet("candsCombinedX", mtype, dataspaceVecX);
      ...
      H5::DataSet datasetVec3 =
          particleGroup.createDataSet("candsCombined3", mtype, dataspaceVec3);
      // datasetVec.write(&particle.candsCombined[0], mtype); /**/
      ...
      H5::DataSet datasetVec4 =
          particleGroup.createDataSet("candsCombined4", mtype, dataspaceVec4);
