...
void backgroundStudy(Int_t NumberOfEvents, Int_t NumberOfClusters,
  ...
  TH2F *hphotonMapX0 =
      new TH2F("Photon Map X0", "Photon Map X0; x [Pads]; y [Pads]", 1000, -10.,
               10., 1000, -10., 10.);

  TH2F *hphotonMapXf =
      new TH2F("Photon Map2Xf", "Photon Map2 Xf; x [Pads]; y [Pads]", 1000,
               -25., 25., 1000, -25., 25.);
  TH2F *hphotonMapCen =
      new TH2F("Photon Map2 Cen", "Photon Map Cen; x [Pads]; y [Pads]", 1000,
               -25., 25., 1000, -25., 25.);
