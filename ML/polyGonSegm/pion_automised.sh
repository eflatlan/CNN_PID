...
for i in {0..49}; do
    ...
    /root/alice/O2/prodtests/sim_challenge.sh -f simp -n 100 || { echo "sim_challenge.sh failed"; exit 1; }
...
#EOF
    ...
    mv ParticleInfo2.h5 ParticleInfo211_Highconst_2cm_${i}_.h5 || { echo "File rename failed"; exit 1; }
done
